...
public:
  ...
  int get_bucket_stats(const DoutPrefixProvider *dpp, optional_yield y,
      ...
      std::map<RGWObjCategory, RGWStorageStats>& stats, std::optional<std::map<std::string, RGWStorageClassStats>>& sc_stats, std::string *max_marker, bool* syncstopped = NULL);
